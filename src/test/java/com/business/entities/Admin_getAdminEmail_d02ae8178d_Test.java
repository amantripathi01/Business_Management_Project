...
public class Admin_getAdminEmail_d02ae8178d_Test {
    ...
    public void testGetAdminEmail() {
        ...
        Assert.assertEquals("admin@example.com", admin.getAdminEmail());
    }
    ...
    public void testGetAdminEmailNotNull() {
        Admin admin = new Admin();
        admin.setAdminEmail("admin@example.com");
        Assert.assertNotNull(admin.getAdminEmail());
    }
    ...
    public void testGetAdminEmailIsString() {
        Admin admin = new Admin();
        admin.setAdminEmail("admin@example.com");
        Assert.assertTrue(admin.getAdminEmail() instanceof String);
    }
    ...
    public void testGetAdminEmailValidFormat() {
        Admin admin = new Admin();
        admin.setAdminEmail("admin@example.com");
        Assert.assertTrue(admin.getAdminEmail().matches("^[\\w-]+(\\.[\\w-]+)*@[\\w-]+(\\.[\\w-]+)*(\\.[a-zA-Z]{2,})$"));
    }
    ...
    public void testGetAdminEmailAppropriateLength() {
        Admin admin = new Admin();
        admin.setAdminEmail("admin@example.com");
        Assert.assertTrue(admin.getAdminEmail().length() > 5 && admin.getAdminEmail().length() < 255);
    }
    ...
    public void testGetAdminEmailNoSpecialCharacters() {
        Admin admin = new Admin();
        admin.setAdminEmail("admin@example.com");
        Assert.assertTrue(admin.getAdminEmail().matches("^[a-zA-Z0-9@.]*$"));
    }
}
